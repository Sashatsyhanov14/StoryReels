...
const PRESET_PROMPTS = [
  {
    title: "Киберпанк-детектив",
    emoji: "🕵️‍♂️",
    prompt: "Киберпанк-исследователь выслеживает цифрового призрака сквозь залитые неоном дождливые аллеи Нео-Токио.",
  ...
  },
  {
    ...
    emoji: "🚀",
    prompt: "Исследователь обнаруживает массивную, светящуюся кристаллическую древнюю структуру на далекой экзопланете с фиолетовыми кольцами.",
    color: "from-cyan-500 to-blue-600",
    theme: "space",
  },
  {
    title: "Средневековая магия",
    emoji: "🧙‍♂️",
    prompt: "Молодой ученик чародея находит спрятанную светящуюся книгу заклинаний в темной, древней библиотеке глубоко в горах.",
    color: "from-emerald-500 to-teal-600",
    theme: "fantasy",
  },
  {
    title: "Синтвейв закат",
    emoji: "🌅",
    prompt: "Ретро-футуристический спорткар вечно мчится к массивному светящемуся солнцу из каркасной сетки по розовому шоссе.",
    ...
    scenes: [
      {
        ...
        audioUrl: "#",
        text: "Неоновые огни Нео-Токио просачивались сквозь непрекращающийся дождь, освещая город, построенный на секретах.",
      ...
      },
      {
        ...
        audioUrl: "#",
        text: "Детектив Каэль сканировал цифровые остатки, оставленные неуловимым фантомным кодером.",
      ...
      },
      {
        ...
        audioUrl: "#",
        text: "Глубоко в подбрюшье Района 9 пульсировал искусственной жизнью огромный массив серверов.",
    ...
    scenes: [
      {
        ...
        audioUrl: "#",
        text: "Командор Вэнс посмотрела вниз на кольцевую планету, чувствуя странный резонанс в своих костях.",
        imagePrompt: "astronaut looking at cosmic ringed purple exoplanet",
      },
      {
        imageUrl: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=600&q=80",
        audioUrl: "#",
        text: "Кристаллический шпиль вырвался из лавандовой почвы, напевая на частоте, неслышимой для человеческих ушей.",
      ...
      scenes: [
        {
          ...
          audioUrl: "#",
          text: `В мире, определяемом вашим воображением, начинается история: "${prompt}"`,
          imagePrompt: prompt,
        },
        {
          imageUrl: "https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&w=600&q=80",
          audioUrl: "#",
          text: "Элементы выстраиваются в линию, материализуя блестящую последовательность событий под станком ИИ.",
        ...
        },
        {
          ...
          audioUrl: "#",
          text: "Окончательная развязка собирается воедино, вписывая этот нарратив в архивы StoryReels.",
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-semibold">Студия ИИ-Эпизодов</p>
            </div>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-8 lg:max-w-xl">
          ...
          <section className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900/30 p-6 backdrop-blur-md">
            ...
            <p className="mb-6 text-sm text-zinc-400">
              Опишите историю, которую хотите воплотить в жизнь. Наши нейросети напишут сценарий, озвучат персонажей и проиллюстрируют последовательность.
            </p>
            ...
            <form onSubmit={handleGenerate} className="flex flex-col gap-4">
              <div className="relative">
                <textarea
                  ...
                  placeholder="например: Кибернетический исследователь приземляется на яркую фиолетовую планету, населенную существами из света..."
              ...
              >
                {isGenerating ? (
                  ...
                  <>
                    <span>Сгенерировать эпизод</span>
            ...
            {isGenerating && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-zinc-950/95 p-8 text-center animate-fade-in backdrop-blur-md">
                ...
                <div className="w-full max-w-xs mb-6">
                  <div className="flex justify-between text-xs text-zinc-400 mb-2 font-mono">
                    <span>
                      ...
                      {genStep === "keyframes" && "🎨 Рендеринг сцен..."}
                ...
                <p className="text-xs text-zinc-500 max-w-xs">
                  Этот процесс имитирует создание сценария (LLM) и рендеринг ассетов сцен (Flux и Audio) внутри конвейеров базы данных StoryReels.
                </p>
              </div>
            )}
          </section>
          ...
          <section className="rounded-3xl border border-zinc-800 bg-zinc-900/30 p-6">
            <h2 className="mb-2 text-base font-bold text-white flex items-center gap-2">
              <span>🪙</span> Песочница токенов и монетизации
            </h2>
            <p className="mb-4 text-xs text-zinc-400">
              Каждая генерация эпизода списывает 1 токен. Реальные платежные операции безопасно проходят через шлюз ЮKassa.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center justify-between rounded-2xl border border-zinc-800 bg-zinc-950/40 p-4 text-center">
                <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Старт</span>
        ...
        <div className="flex flex-1 flex-col gap-8">
          ...
          {selectedEpisode ? (
                ...
                {selectedEpisode.scenes.length > 0 ? (
                  <>
                    ...
                    <div className="absolute top-4 right-4 flex items-center gap-1.5 rounded-lg bg-black/40 px-2.5 py-1.5 backdrop-blur-md border border-white/10">
                      ...
                      <span className="text-[10px] font-mono text-zinc-300">TTS Аудио синхронизировано</span>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-800 p-12 text-center bg-zinc-900/10">
              ...
              <p className="text-sm text-zinc-400">Выберите или сгенерируйте эпизод слева, чтобы начать просмотр</p>
            </div>
          )}

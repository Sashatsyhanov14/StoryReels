...
const PRESET_PROMPTS = [
  {
    title: "Кошачий Король",
    emoji: "👑",
    prompt: "Король Лев-Кот в черной мантии, стоящий на троне, пока другие коты-крестьяне кланяются ему. 16-bit JRPG стиль.",
    color: "from-amber-500 to-orange-600",
    theme: "kingdom",
    chips: ["Объявить налог на рыбу", "Отправить рыцарей в поход", "Принять дары крестьян"],
  },
  {
    title: "Рыцарь Енот",
    emoji: "⚔️",
    prompt: "Храбрый енот-рыцарь в сияющих доспехах защищает деревню от нападения гоблинов-крыс. 16-bit JRPG стиль.",
    color: "from-blue-500 to-indigo-600",
    theme: "knight",
    chips: ["Поднять щит", "Сделать рывок с мечом", "Позвать подкрепление"],
  },
  {
    title: "Маг Лис",
    emoji: "🔮",
    prompt: "Мудрый лис-маг в фиолетовой мантии кастует древнее заклинание в темном лесу. 16-bit JRPG стиль.",
    color: "from-purple-500 to-fuchsia-600",
    theme: "magic",
    chips: ["Кастовать Огненный шар", "Скрыться в тумане", "Телепортироваться"],
  },
  {
    title: "Темный Волк",
    emoji: "🐺",
    prompt: "Волк-Ассасин стоит на крыше готического замка под кровавой луной, готовясь к прыжку. 16-bit JRPG стиль.",
    color: "from-red-600 to-rose-700",
    theme: "assassin",
    chips: ["Прыгнуть в тень", "Метнуть кинжалы", "Издать боевой вой"],
  },
];
...
const INITIAL_EPISODES: Episode[] = [
  {
    ...
    prompt: "Храбрый енот-рыцарь защищает деревню",
    status: "ready",
    ...
    scenes: [
      {
        ...
        audioUrl: "#",
        text: "Мирная деревня кошачьего королевства спала, не подозревая о надвигающейся угрозе из подземелий.",
        imagePrompt: "16-bit pixel art style, retro JRPG aesthetic, peaceful village at night",
      ...
      },
      {
        ...
        audioUrl: "#",
        text: "Сэр Рокки, енот-рыцарь, первым услышал скрежет когтей о камни мостовой.",
        imagePrompt: "16-bit pixel art style, raccoon knight looking alarmed in armor",
      ...
      },
      {
        ...
        audioUrl: "#",
        text: "Армия гоблинов-крыс прорвала оборону, и начался великий бой за престол.",
        imagePrompt: "16-bit pixel art style, army of rat goblins attacking, swords and shields",
